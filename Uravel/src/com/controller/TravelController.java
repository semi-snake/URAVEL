	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("list")) {
			...
			if (Integer.parseInt(request.getParameter("likeYn")) == 0) {
				int likeYn = travelBiz.insertLike(Integer.parseInt(request.getParameter("travelno")),
						(Integer.parseInt(request.getParameter("userno"))));
				PrintWriter out = response.getWriter();
				out.print(likeYn);
			} else {
				int likeYn = travelBiz.deleteLike(Integer.parseInt(request.getParameter("travelno")),
						(Integer.parseInt(request.getParameter("userno"))));
				PrintWriter out = response.getWriter();
				out.print(likeYn);
			}
			...
			if (Integer.parseInt(request.getParameter("likeYn")) == 0) {
				int themeLikeYn = travelBiz.insertLike(Integer.parseInt(request.getParameter("travelno")),
						(Integer.parseInt(request.getParameter("userno"))));
				PrintWriter out = response.getWriter();
				out.print(themeLikeYn);
			} else {
				int themeLikeYn = travelBiz.deleteLike(Integer.parseInt(request.getParameter("travelno")),
						(Integer.parseInt(request.getParameter("userno"))));
				PrintWriter out = response.getWriter();
				out.print(themeLikeYn);
			}
