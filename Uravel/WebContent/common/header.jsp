   ...
   <header>
      ...
      <nav>
         ...
         <ul class="menu">
            ...
            <li><a
               href="${pageContext.request.contextPath}/history/history_Controller?command=list">역사
                  문화</a></li>
            <li><a href="${pageContext.request.contextPath}/review/ReviewController?command=list">후기</a></li>
            <li><a
         ...
         <ul class="login">
            ...
            %>
            <li><a
               href="${pageContext.request.contextPath}/Admin?command=travellist">관리자 페이지</a></li>
            <li><a
               href="${pageContext.request.contextPath}/user/logincontroller.jsp?command=logout">로그아웃</a></li>
            <%
            }
