	    ...
	    <article class="history-desc">
	    	...
	    	<div class="history-desc-content">
	    		<div class="history-desc-content-img">
		    		<img src="http://www.heritage.go.kr/unisearch/images/national_treasure/2021062917265903.jpg">
		    		<br>
		    		<img src="http://www.heritage.go.kr/unisearch/images/national_treasure/1611714.jpg">
	    		</div>
	    		...
	    		<p class="history-desc-content-text">
	    			...
	    			흥선대원군이 주도한 중건 경복궁은 500여 동의 건물들이 미로같이 빼곡히 들어선 웅장한 모습 이었다.
	    			<br><br>
					...
					다행히 1990년부터 본격적인 복원 사업이 추진되어 총독부 건물을 철거하고 흥례문 일원을 복원하였으며, 왕과 왕비의 침전, 동궁, 건청궁, 태원전 일원의 모습을 되찾고 있다.
					<br><br>
					...
					수도 서울의 중심이고 조선의 으뜸 궁궐인 경복궁에서 격조 높고 품위 있는 왕실 문화의 진수를 느껴보자.
					<br><br>
					경복궁의 명칭 : 경복궁은 조선 왕조가 세워지고 3년 지난 후 완공되었다. 
					완공된 지 며칠 후에 개국공신 정도전은 태조의명에 따라 경복궁이라는 궁궐 이름을 비롯해 강녕전, 교태전, 연생전, 경성전, 사정전, 근정전 등 주요 전각의 이름을 지었다. 
					경복궁이라는 이름에는 ‘새 왕조가 큰 복을 누려 번영할 것’이라는 의미가 담겨 있다.
	    		</p>
