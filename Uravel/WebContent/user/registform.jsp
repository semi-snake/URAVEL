...
<script type="text/javascript">
	function idChk() {
		...
		if (doc.value.trim() == "" || doc.value == null) {
			...
			var target = "logincontroller.jsp?command=idchk&id="
					+ doc.value.trim();
...
<body>
	<form action="logincontroller.jsp" method="post">
		<input type="hidden" name="command" value="insertuser"> <input
			type="hidden" name="command" value="insertlocal">
			...
			<section class="signup-wrap">
				<div>
					...
					<span class="signup-input"> <input id="signup-id"
						type="text" name="userid" title="n" placeholder="아이디를 입력하세요">
						<input type="button" value="중복체크" onclick="idChk();">
					</span>

					<h3>*비밀번호</h3>
					<span class="signup-input"> <input id="signup-pw"
						type="password" name="userpw" onclick="idChkConfirm();"> <span
						class="pw-lock"></span>
					</span>
				</div>
				...
				<div style="margin-top: 20px;">
					...
					<span class="signup-input"> <input id="signup-name"
						type="text" name="username" onclick="idChkConfirm();">
					</span>

					<h3>생년월일</h3>
					<span style="display: flex;"> <span class="signup-input">
							<input id="signup-birth-yy" type="date" name="birth"
							onclick="idChkConfirm();">
					</span>

					</span>
					<h3>*이메일</h3>
					<span class="choice"> </span> <span class="signup-input"> <input
						type="email" name="email" placeholder="이메일을 입력하세요"
						onclick="idChkConfirm();">
					</span>
				</div>
				...
				<div style="margin-top: 20px;">
					...
					<span class="signup-input"
						...
						type="text" name="phone" placeholder="010-****-****"
						onclick="idChkConfirm();">
					</span>
				</div>
